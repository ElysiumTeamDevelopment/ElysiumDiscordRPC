...
Готовые примеры использования ElysiumDiscordRPC в различных сценариях.

## 📋 Содержание

- 🎮 **[Базовая интеграция](#базовая-интеграция)** - простое использование в игре
- 🎭 **[Отслеживание персонажей](#отслеживание-персонажей)** - статусы для диалогов
- 📖 **[Система глав](#система-глав)** - прогресс по главам
- 🎛️ **[Кастомный UI](#кастомный-ui)** - собственный интерфейс настроек
- 🔄 **[Автоматизация](#автоматизация)** - автоматическое отслеживание
- 🎯 **[Продвинутые сценарии](#продвинутые-сценарии)** - сложные случаи
...
label start:
    ...
    $ discord_set_custom("Начало приключения", config.name)
    
    "Добро пожаловать в мир нашей игры!"
    
    # Статус главного меню при возврате
